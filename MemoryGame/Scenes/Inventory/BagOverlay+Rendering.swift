...
extension BagOverlay {
    ...
    @discardableResult
    func box(_ size: CGSize, at point: CGPoint, fill: SKColor, stroke: SKColor, in parent: SKNode, radius: CGFloat = 3) -> SKShapeNode {
    ...
    @discardableResult
    func label(_ text: String, at point: CGPoint, size: CGFloat, in parent: SKNode, width: CGFloat = 0) -> SKLabelNode {
    ...
    func button(_ text: String, name: String, at point: CGPoint, width: CGFloat, in parent: SKNode) {
    ...
    func addIcon(_ item: BagItem, to parent: SKNode, size: CGFloat) {
        switch item {
        case .book:
